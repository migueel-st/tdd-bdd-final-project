...
def list_products():
    """
    Reads a Product
    This endpoint will read a Product based product id given
    """
...
def update_products(product_id):
    """
    Updates a Product
    This endpoint will update a Product based on the given payload
    """
...
def delete_products(product_id):
    """
    Deletes a Product
    This endpoint will delete a Product based product id given
    """
